...
contract ERC20Collateral {
    ...
    function deposit(uint amount) external {
        ...
        //@audit => Missing to check the return value
    ...
    function liquidate(address lender) external {
        ...
        //@audit => Missing to validate if the call() was succesful, what happens when a call() fails but the external function doesn't return anything?
